import { SplitComplementaryThemeFactory } from '../src/classes/SplitComplementaryThemeFactory'
...
describe('SplitComplementaryThemeFactory.ts', () => {
  test('return type  - getColorTheme', () => {
    const colorTheme = new SplitComplementaryThemeFactory()
  ...
  test('invlaid value of arguments - getColorTheme', () => {
    ...
    expect(() => colorTheme.getColorTheme(2)).toThrowError()
  })
